...
import blockedHostsList from "./helpers/blocked-hosts";
...
import {
  ...
  formatDate,
  SessionExpired,
} from "./helpers/LinkedInHelper";

// ----------------------------------------------

// refer this link for more information:
// https://github.com/josephlimtech/linkedin-profile-scraper-api/blob/master/src/index.ts
...
export class LinkedInProfileScraper {
  ...
  run = async (profileUrl) => {
    ...
    try {
      ...
      const rawExperiencesData = await page.$$eval(
      ...
      const rawEducationData = await page.$$eval(
      ...
      const rawVolunteerExperiences = await page.$$eval(
